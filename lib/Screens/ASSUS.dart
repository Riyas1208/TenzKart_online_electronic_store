...
class AssusItems extends StatelessWidget {
  AssusItems({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    var Assushome = context.watch<GadgetCartProvider>().Asushome;
    var Assuscart = context.watch<GadgetCartProvider>().cartall;
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                GridView.builder(
                    itemCount: Assushome.length,
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2, childAspectRatio:0.8),
                    itemBuilder: (context, index) {
                      var iphone= Assushome[index];
                      return ItemTile(

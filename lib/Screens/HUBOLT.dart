...
class HuboltItems extends StatelessWidget {
  HuboltItems({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    var Hubolthome = context.watch<GadgetCartProvider>().Hubolthome;
    var Huboltcart = context.watch<GadgetCartProvider>().cartall;
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                GridView.builder(
                    itemCount: Hubolthome.length,
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2, childAspectRatio:0.8),
                    itemBuilder: (context, index) {
                      var iphone= Hubolthome[index];
                      return ItemTile(
